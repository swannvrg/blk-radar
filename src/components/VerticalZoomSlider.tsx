    ...
    <div className="relative h-full w-12 flex flex-col items-center group py-4">
      <div className="mb-4 transition-all duration-300 group-hover:scale-110">
        ...
        >
          ...
          {/* Petit reflet ou signe '+' optionnel à l'intérieur */}
      ...
      <div className="relative flex-1 w-2 bg-zinc-900/80 rounded-full border border-white/5 shadow-inner">
        {/* GRADUATIONS : On les espace exactement selon les 9 niveaux */}
        ...
        {/* Curseur rond (Bloqué au min/max par le calcul du pourcentage) */}
        <div
